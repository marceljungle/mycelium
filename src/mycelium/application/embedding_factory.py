...
def create_embedding_generator(
    ...
    if embedding_type == EmbeddingModelType.CLAP:
        from ..infrastructure.clap_adapter import CLAPEmbeddingGenerator
        ...
        return CLAPEmbeddingGenerator(
            ...
            num_chunks=clap_cfg.num_chunks,
            max_load_duration_s=clap_cfg.max_load_duration_s,
        )

    if embedding_type == EmbeddingModelType.MUQ:
        from ..infrastructure.muq_adapter import MuQEmbeddingGenerator
        ...
        return MuQEmbeddingGenerator(
            ...
            num_chunks=muq_cfg.num_chunks,
            max_load_duration_s=muq_cfg.max_load_duration_s,
        )
